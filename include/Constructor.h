 ...
 * pointer.
 *
 * The overall structure of this file is as follows (in pseudocode):
 *
 * @code
 * 	for (N in (0..9))
 *  	template struct ConstrN {
 *  		// define the static Create() function with (0..N) arguments
 *  	}
 *  for (N in (0..9))
 *  	function createConstructor(dummyFunction with (0..N) arguments) {
 *  		// return ConstrN::Create pointer
 *  	}
 * @endcode
 */
